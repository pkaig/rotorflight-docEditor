 ...
 *   lives here rather than at each of the ~40 path.join() call sites:
 *   reject anything unsafe once, right after it's read off the request,
 *   before it ever reaches a path.join call.
 */
